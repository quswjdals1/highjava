...
public class BoardController {
	...
	private void updateOrDeleteBoard() {
		...
		System.out.println("-------------------------------------");
		System.out.println("제 목:"+selectBoard.getBoard_title());
		System.out.println("작성자:"+selectBoard.getBoard_writer());
		System.out.println("내 용:"+selectBoard.getBoard_content());
		System.out.println("작성일:"+selectBoard.getBoard_date());
		System.out.println("조회수:"+selectBoard.getBoard_cnt());
		System.out.println("-------------------------------------");
